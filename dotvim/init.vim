...
" Create a soft link from $HOME/configs/dotvim/nvim_ide.vim
" to $HOME/.config/nvim_ide.vim to enable
let nvim_ide_file=expand('~/.config/nvim_ide.vim')
if filereadable(nvim_ide_file)
	exec 'source' nvim_ide_file
endif
